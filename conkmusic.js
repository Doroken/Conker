...
client.on("message", (message) => {
  ...
  if (message.content.startsWith("ping4")) {
    ...
    message.channel.send({
      "embed": {
    "description": stripIndents`These are all midi files. They're great. Song request? Slide into Doro's DMs.\nCurrent song count: ${songCount}\nOptionally, put a - before the song name to play it from glitch.com, rather than the local script, ex. \`>-allstar\`. Be warned that it is very very laggy! I don't know why you'd want this.`,
	"color": 2254003,
      "thumbnail": {
